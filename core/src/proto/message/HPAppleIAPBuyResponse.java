...
public final class HPAppleIAPBuyResponse
        implements io.protostuff.Message<HPAppleIAPBuyResponse> {

    private static final HPAppleIAPBuyResponse DEFAULT_INSTANCE = newBuilder().build();
    ...
    private HPAppleIAPBuyResponse(Builder builder) {
        __merge_lock = true;
    }
    ...
    public static HPAppleIAPBuyResponse getDefaultInstance() {
        return DEFAULT_INSTANCE;
    }

    public static io.protostuff.Schema<HPAppleIAPBuyResponse> getSchema()
    {
    ...
    public HPAppleIAPBuyResponse withReturnCode(int value) {
        return HPAppleIAPBuyResponse.newBuilder()
            .mergeFrom(this)
            .setReturnCode(value)
            .build();
    }
    ...
    public HPAppleIAPBuyResponse withReturnMessge(String value) {
        return HPAppleIAPBuyResponse.newBuilder()
            .mergeFrom(this)
    ...
    public HPAppleIAPBuyResponse withAmount(int value) {
        return HPAppleIAPBuyResponse.newBuilder()
            .mergeFrom(this)
            .setAmount(value)
            .build();
    ...
    public HPAppleIAPBuyResponse withGold1(int value) {
        return HPAppleIAPBuyResponse.newBuilder()
            .mergeFrom(this)
            .setGold1(value)
            .build();
    ...
    public HPAppleIAPBuyResponse withGold2(int value) {
        return HPAppleIAPBuyResponse.newBuilder()
            .mergeFrom(this)
            .setGold2(value)
            .build();
    ...
    public HPAppleIAPBuyResponse withGold3(int value) {
        return HPAppleIAPBuyResponse.newBuilder()
            .mergeFrom(this)
            .setGold3(value)
            .build();
    ...
    public HPAppleIAPBuyResponse withHappyPlayCount(int value) {
        return HPAppleIAPBuyResponse.newBuilder()
            .mergeFrom(this)
    ...
    public HPAppleIAPBuyResponse withTransactionId(String value) {
        return HPAppleIAPBuyResponse.newBuilder()
            .mergeFrom(this)
    ...
    public HPAppleIAPBuyResponse withHappyPlayEventNewCount(int value) {
        return HPAppleIAPBuyResponse.newBuilder()
            .mergeFrom(this)
    ...
    public HPAppleIAPBuyResponse withPetGoldBuff(int value) {
        return HPAppleIAPBuyResponse.newBuilder()
            .mergeFrom(this)
    ...
    public HPAppleIAPBuyResponse withTicketBuffCnt(int value) {
        return HPAppleIAPBuyResponse.newBuilder()
            .mergeFrom(this)
    ...
    public HPAppleIAPBuyResponse withItemId(String value) {
        return HPAppleIAPBuyResponse.newBuilder()
            .mergeFrom(this)
            .setItemId(value)
            .build();
    ...
    public HPAppleIAPBuyResponse withListClaimedBoosterItem(proto.message.HPBoosterPackInfoResponse value) {
        return HPAppleIAPBuyResponse.newBuilder()
            .mergeFrom(this)
    ...
    public HPAppleIAPBuyResponse withListClaimedSpecialOfferItem(proto.message.HPSpecialOfferPackInfoResponse value) {
        return HPAppleIAPBuyResponse.newBuilder()
            .mergeFrom(this)
    ...
    @Override
    public io.protostuff.Schema<HPAppleIAPBuyResponse> cachedSchema() {
        return Schema.INSTANCE;
    }
    ...
    public boolean equals(Object obj) {
        ...
        HPAppleIAPBuyResponse that = (HPAppleIAPBuyResponse) obj;
    ...
    public String toString() {
        ...
        return "HPAppleIAPBuyResponse{" + String.join(", ", parts) + "}";
    }

    public static final class Schema implements io.protostuff.Schema<HPAppleIAPBuyResponse>{
        ...
        @Override
        public HPAppleIAPBuyResponse newMessage() {
            return new HPAppleIAPBuyResponse();
        }

        @Override
        public Class<HPAppleIAPBuyResponse> typeClass() {
            return HPAppleIAPBuyResponse.class;
        }

        @Override
        public String messageName() {
            return HPAppleIAPBuyResponse.class.getSimpleName();
        }

        @Override
        public String messageFullName() {
            return HPAppleIAPBuyResponse.class.getName();
        }

        @Override
        @Deprecated
        public boolean isInitialized(HPAppleIAPBuyResponse message) {
            return true;
        }

        @Override
        public void mergeFrom(io.protostuff.Input input, HPAppleIAPBuyResponse instance) throws java.io.IOException {
        ...
        @Override
        public void writeTo(io.protostuff.Output output, HPAppleIAPBuyResponse instance) throws java.io.IOException {
    ...
    public static final class Builder  {
        ...
        public Builder mergeFrom(HPAppleIAPBuyResponse instance) {
        ...
        public Builder setReturnMessge(String value) {
            if (value == null) {
                throw new NullPointerException("Cannot set HPAppleIAPBuyResponse#returnMessge to null");
            }
        ...
        public Builder setTransactionId(String value) {
            if (value == null) {
                throw new NullPointerException("Cannot set HPAppleIAPBuyResponse#transactionId to null");
            }
        ...
        public Builder setItemId(String value) {
            if (value == null) {
                throw new NullPointerException("Cannot set HPAppleIAPBuyResponse#itemId to null");
            }
        ...
        public Builder setListClaimedBoosterItem(proto.message.HPBoosterPackInfoResponse value) {
            if (value == null) {
                throw new NullPointerException("Cannot set HPAppleIAPBuyResponse#listClaimedBoosterItem to null");
            }
        ...
        public Builder setListClaimedSpecialOfferItem(proto.message.HPSpecialOfferPackInfoResponse value) {
            if (value == null) {
                throw new NullPointerException("Cannot set HPAppleIAPBuyResponse#listClaimedSpecialOfferItem to null");
            }
        ...
        public HPAppleIAPBuyResponse build() {
            proto.message.HPAppleIAPBuyResponse result = new proto.message.HPAppleIAPBuyResponse();
