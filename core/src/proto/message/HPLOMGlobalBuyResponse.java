...
public final class HPLOMGlobalBuyResponse
        implements io.protostuff.Message<HPLOMGlobalBuyResponse> {

    private static final HPLOMGlobalBuyResponse DEFAULT_INSTANCE = newBuilder().build();
    ...
    private HPLOMGlobalBuyResponse() {
        this.returnCode = 0;
        this.returnMessge = "";
        this.amount = 0;
        this.gold1 = 0;
    ...
    private HPLOMGlobalBuyResponse(Builder builder) {
        __merge_lock = true;
    }
    ...
    public static HPLOMGlobalBuyResponse getDefaultInstance() {
        return DEFAULT_INSTANCE;
    }

    public static io.protostuff.Schema<HPLOMGlobalBuyResponse> getSchema()
    {
    ...
    public HPLOMGlobalBuyResponse withReturnCode(int value) {
        return HPLOMGlobalBuyResponse.newBuilder()
            .mergeFrom(this)
            .setReturnCode(value)
            .build();
    }
    ...
    public HPLOMGlobalBuyResponse withReturnMessge(String value) {
        return HPLOMGlobalBuyResponse.newBuilder()
            .mergeFrom(this)
    ...
    public HPLOMGlobalBuyResponse withAmount(int value) {
        return HPLOMGlobalBuyResponse.newBuilder()
            .mergeFrom(this)
            .setAmount(value)
            .build();
    ...
    public HPLOMGlobalBuyResponse withGold1(int value) {
        return HPLOMGlobalBuyResponse.newBuilder()
            .mergeFrom(this)
            .setGold1(value)
            .build();
    ...
    public HPLOMGlobalBuyResponse withGold2(int value) {
        return HPLOMGlobalBuyResponse.newBuilder()
            .mergeFrom(this)
            .setGold2(value)
            .build();
    ...
    public HPLOMGlobalBuyResponse withGold3(int value) {
        return HPLOMGlobalBuyResponse.newBuilder()
            .mergeFrom(this)
            .setGold3(value)
            .build();
    ...
    public HPLOMGlobalBuyResponse withHappyPlayCount(int value) {
        return HPLOMGlobalBuyResponse.newBuilder()
            .mergeFrom(this)
    ...
    public HPLOMGlobalBuyResponse withTransactionId(String value) {
        return HPLOMGlobalBuyResponse.newBuilder()
            .mergeFrom(this)
    ...
    public HPLOMGlobalBuyResponse withHappyPlayEventNewCount(int value) {
        return HPLOMGlobalBuyResponse.newBuilder()
            .mergeFrom(this)
    ...
    public HPLOMGlobalBuyResponse withPetGoldBuff(int value) {
        return HPLOMGlobalBuyResponse.newBuilder()
            .mergeFrom(this)
    ...
    public HPLOMGlobalBuyResponse withTicketBuffCnt(int value) {
        return HPLOMGlobalBuyResponse.newBuilder()
            .mergeFrom(this)
    ...
    public HPLOMGlobalBuyResponse withOrderId(String value) {
        return HPLOMGlobalBuyResponse.newBuilder()
            .mergeFrom(this)
            .setOrderId(value)
            .build();
    ...
    public HPLOMGlobalBuyResponse withItemId(String value) {
        return HPLOMGlobalBuyResponse.newBuilder()
            .mergeFrom(this)
            .setItemId(value)
            .build();
    ...
    public HPLOMGlobalBuyResponse withListClaimedBoosterItem(proto.message.HPBoosterPackInfoResponse value) {
        return HPLOMGlobalBuyResponse.newBuilder()
            .mergeFrom(this)
    ...
    public HPLOMGlobalBuyResponse withListClaimedSpecialOfferItem(proto.message.HPSpecialOfferPackInfoResponse value) {
        return HPLOMGlobalBuyResponse.newBuilder()
            .mergeFrom(this)
    ...
    @Override
    public io.protostuff.Schema<HPLOMGlobalBuyResponse> cachedSchema() {
        return Schema.INSTANCE;
    }
    ...
    public boolean equals(Object obj) {
        ...
        HPLOMGlobalBuyResponse that = (HPLOMGlobalBuyResponse) obj;
    ...
    public String toString() {
        ...
        return "HPLOMGlobalBuyResponse{" + String.join(", ", parts) + "}";
    }

    public static final class Schema implements io.protostuff.Schema<HPLOMGlobalBuyResponse>{
        ...
        @Override
        public HPLOMGlobalBuyResponse newMessage() {
            return new HPLOMGlobalBuyResponse();
        }

        @Override
        public Class<HPLOMGlobalBuyResponse> typeClass() {
            return HPLOMGlobalBuyResponse.class;
        }

        @Override
        public String messageName() {
            return HPLOMGlobalBuyResponse.class.getSimpleName();
        }

        @Override
        public String messageFullName() {
            return HPLOMGlobalBuyResponse.class.getName();
        }

        @Override
        @Deprecated
        public boolean isInitialized(HPLOMGlobalBuyResponse message) {
            return true;
        }

        @Override
        public void mergeFrom(io.protostuff.Input input, HPLOMGlobalBuyResponse instance) throws java.io.IOException {
        ...
        @Override
        public void writeTo(io.protostuff.Output output, HPLOMGlobalBuyResponse instance) throws java.io.IOException {
    ...
    public static final class Builder  {
        ...
        public Builder mergeFrom(HPLOMGlobalBuyResponse instance) {
        ...
        public Builder setReturnMessge(String value) {
            if (value == null) {
                throw new NullPointerException("Cannot set HPLOMGlobalBuyResponse#returnMessge to null");
            }
        ...
        public Builder setTransactionId(String value) {
            if (value == null) {
                throw new NullPointerException("Cannot set HPLOMGlobalBuyResponse#transactionId to null");
            }
        ...
        public Builder setOrderId(String value) {
            if (value == null) {
                throw new NullPointerException("Cannot set HPLOMGlobalBuyResponse#orderId to null");
            }
        ...
        public Builder setItemId(String value) {
            if (value == null) {
                throw new NullPointerException("Cannot set HPLOMGlobalBuyResponse#itemId to null");
            }
        ...
        public Builder setListClaimedBoosterItem(proto.message.HPBoosterPackInfoResponse value) {
            if (value == null) {
                throw new NullPointerException("Cannot set HPLOMGlobalBuyResponse#listClaimedBoosterItem to null");
            }
        ...
        public Builder setListClaimedSpecialOfferItem(proto.message.HPSpecialOfferPackInfoResponse value) {
            if (value == null) {
                throw new NullPointerException("Cannot set HPLOMGlobalBuyResponse#listClaimedSpecialOfferItem to null");
            }
        ...
        public HPLOMGlobalBuyResponse build() {
            proto.message.HPLOMGlobalBuyResponse result = new proto.message.HPLOMGlobalBuyResponse();
