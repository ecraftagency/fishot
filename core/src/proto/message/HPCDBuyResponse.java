...
public final class HPCDBuyResponse
        implements io.protostuff.Message<HPCDBuyResponse> {

    private static final HPCDBuyResponse DEFAULT_INSTANCE = newBuilder().build();
    ...
    private HPCDBuyResponse(Builder builder) {
        __merge_lock = true;
    }
    ...
    public static HPCDBuyResponse getDefaultInstance() {
        return DEFAULT_INSTANCE;
    }

    public static io.protostuff.Schema<HPCDBuyResponse> getSchema()
    {
    ...
    public HPCDBuyResponse withReturnCode(int value) {
        return HPCDBuyResponse.newBuilder()
            .mergeFrom(this)
            .setReturnCode(value)
            .build();
    }
    ...
    public HPCDBuyResponse withReturnMessge(String value) {
        return HPCDBuyResponse.newBuilder()
            .mergeFrom(this)
    ...
    public HPCDBuyResponse withAmount(int value) {
        return HPCDBuyResponse.newBuilder()
            .mergeFrom(this)
            .setAmount(value)
            .build();
    ...
    public HPCDBuyResponse withGold1(int value) {
        return HPCDBuyResponse.newBuilder()
            .mergeFrom(this)
            .setGold1(value)
            .build();
    ...
    public HPCDBuyResponse withGold2(int value) {
        return HPCDBuyResponse.newBuilder()
            .mergeFrom(this)
            .setGold2(value)
            .build();
    ...
    public HPCDBuyResponse withGold3(int value) {
        return HPCDBuyResponse.newBuilder()
            .mergeFrom(this)
            .setGold3(value)
            .build();
    ...
    public HPCDBuyResponse withHappyPlayCount(int value) {
        return HPCDBuyResponse.newBuilder()
            .mergeFrom(this)
    ...
    public HPCDBuyResponse withTransactionId(String value) {
        return HPCDBuyResponse.newBuilder()
            .mergeFrom(this)
    ...
    public HPCDBuyResponse withHappyPlayEventNewCount(int value) {
        return HPCDBuyResponse.newBuilder()
            .mergeFrom(this)
    ...
    public HPCDBuyResponse withPetGoldBuff(int value) {
        return HPCDBuyResponse.newBuilder()
            .mergeFrom(this)
    ...
    public HPCDBuyResponse withTicketBuffCnt(int value) {
        return HPCDBuyResponse.newBuilder()
            .mergeFrom(this)
    ...
    public HPCDBuyResponse withOrderId(String value) {
        return HPCDBuyResponse.newBuilder()
            .mergeFrom(this)
            .setOrderId(value)
            .build();
    ...
    public HPCDBuyResponse withItemId(String value) {
        return HPCDBuyResponse.newBuilder()
            .mergeFrom(this)
            .setItemId(value)
            .build();
    ...
    public HPCDBuyResponse withListClaimedBoosterItem(proto.message.HPBoosterPackInfoResponse value) {
        return HPCDBuyResponse.newBuilder()
            .mergeFrom(this)
    ...
    public HPCDBuyResponse withListClaimedSpecialOfferItem(proto.message.HPSpecialOfferPackInfoResponse value) {
        return HPCDBuyResponse.newBuilder()
            .mergeFrom(this)
    ...
    @Override
    public io.protostuff.Schema<HPCDBuyResponse> cachedSchema() {
        return Schema.INSTANCE;
    }
    ...
    public boolean equals(Object obj) {
        ...
        HPCDBuyResponse that = (HPCDBuyResponse) obj;
    ...
    public String toString() {
        ...
        return "HPCDBuyResponse{" + String.join(", ", parts) + "}";
    }

    public static final class Schema implements io.protostuff.Schema<HPCDBuyResponse>{
        ...
        @Override
        public HPCDBuyResponse newMessage() {
            return new HPCDBuyResponse();
        }

        @Override
        public Class<HPCDBuyResponse> typeClass() {
            return HPCDBuyResponse.class;
        }

        @Override
        public String messageName() {
            return HPCDBuyResponse.class.getSimpleName();
        }

        @Override
        public String messageFullName() {
            return HPCDBuyResponse.class.getName();
        }

        @Override
        @Deprecated
        public boolean isInitialized(HPCDBuyResponse message) {
            return true;
        }

        @Override
        public void mergeFrom(io.protostuff.Input input, HPCDBuyResponse instance) throws java.io.IOException {
        ...
        @Override
        public void writeTo(io.protostuff.Output output, HPCDBuyResponse instance) throws java.io.IOException {
    ...
    public static final class Builder  {
        ...
        public Builder mergeFrom(HPCDBuyResponse instance) {
        ...
        public Builder setReturnMessge(String value) {
            if (value == null) {
                throw new NullPointerException("Cannot set HPCDBuyResponse#returnMessge to null");
            }
        ...
        public Builder setTransactionId(String value) {
            if (value == null) {
                throw new NullPointerException("Cannot set HPCDBuyResponse#transactionId to null");
            }
        ...
        public Builder setOrderId(String value) {
            if (value == null) {
                throw new NullPointerException("Cannot set HPCDBuyResponse#orderId to null");
            }
        ...
        public Builder setItemId(String value) {
            if (value == null) {
                throw new NullPointerException("Cannot set HPCDBuyResponse#itemId to null");
            }
        ...
        public Builder setListClaimedBoosterItem(proto.message.HPBoosterPackInfoResponse value) {
            if (value == null) {
                throw new NullPointerException("Cannot set HPCDBuyResponse#listClaimedBoosterItem to null");
            }
        ...
        public Builder setListClaimedSpecialOfferItem(proto.message.HPSpecialOfferPackInfoResponse value) {
            if (value == null) {
                throw new NullPointerException("Cannot set HPCDBuyResponse#listClaimedSpecialOfferItem to null");
            }
        ...
        public HPCDBuyResponse build() {
            proto.message.HPCDBuyResponse result = new proto.message.HPCDBuyResponse();
