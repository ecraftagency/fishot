...
public final class HPBPBuyResponse
        implements io.protostuff.Message<HPBPBuyResponse> {

    private static final HPBPBuyResponse DEFAULT_INSTANCE = newBuilder().build();
    ...
    private HPBPBuyResponse(Builder builder) {
        __merge_lock = true;
    }
    ...
    public static HPBPBuyResponse getDefaultInstance() {
        return DEFAULT_INSTANCE;
    }

    public static io.protostuff.Schema<HPBPBuyResponse> getSchema()
    {
    ...
    public HPBPBuyResponse withReturnCode(int value) {
        return HPBPBuyResponse.newBuilder()
            .mergeFrom(this)
            .setReturnCode(value)
            .build();
    }
    ...
    public HPBPBuyResponse withReturnMessge(String value) {
        return HPBPBuyResponse.newBuilder()
            .mergeFrom(this)
    ...
    public HPBPBuyResponse withAmount(int value) {
        return HPBPBuyResponse.newBuilder()
            .mergeFrom(this)
            .setAmount(value)
            .build();
    ...
    public HPBPBuyResponse withGold1(int value) {
        return HPBPBuyResponse.newBuilder()
            .mergeFrom(this)
            .setGold1(value)
            .build();
    ...
    public HPBPBuyResponse withGold2(int value) {
        return HPBPBuyResponse.newBuilder()
            .mergeFrom(this)
            .setGold2(value)
            .build();
    ...
    public HPBPBuyResponse withGold3(int value) {
        return HPBPBuyResponse.newBuilder()
            .mergeFrom(this)
            .setGold3(value)
            .build();
    ...
    public HPBPBuyResponse withHappyPlayCount(int value) {
        return HPBPBuyResponse.newBuilder()
            .mergeFrom(this)
    ...
    public HPBPBuyResponse withTransactionId(String value) {
        return HPBPBuyResponse.newBuilder()
            .mergeFrom(this)
    ...
    public HPBPBuyResponse withHappyPlayEventNewCount(int value) {
        return HPBPBuyResponse.newBuilder()
            .mergeFrom(this)
    ...
    public HPBPBuyResponse withPetGoldBuff(int value) {
        return HPBPBuyResponse.newBuilder()
            .mergeFrom(this)
    ...
    public HPBPBuyResponse withTicketBuffCnt(int value) {
        return HPBPBuyResponse.newBuilder()
            .mergeFrom(this)
    ...
    public HPBPBuyResponse withOrderId(String value) {
        return HPBPBuyResponse.newBuilder()
            .mergeFrom(this)
            .setOrderId(value)
            .build();
    ...
    public HPBPBuyResponse withItemId(String value) {
        return HPBPBuyResponse.newBuilder()
            .mergeFrom(this)
            .setItemId(value)
            .build();
    ...
    public HPBPBuyResponse withListClaimedBoosterItem(proto.message.HPBoosterPackInfoResponse value) {
        return HPBPBuyResponse.newBuilder()
            .mergeFrom(this)
    ...
    public HPBPBuyResponse withListClaimedSpecialOfferItem(proto.message.HPSpecialOfferPackInfoResponse value) {
        return HPBPBuyResponse.newBuilder()
            .mergeFrom(this)
    ...
    @Override
    public io.protostuff.Schema<HPBPBuyResponse> cachedSchema() {
        return Schema.INSTANCE;
    }
    ...
    public boolean equals(Object obj) {
        ...
        HPBPBuyResponse that = (HPBPBuyResponse) obj;
    ...
    public String toString() {
        ...
        return "HPBPBuyResponse{" + String.join(", ", parts) + "}";
    }

    public static final class Schema implements io.protostuff.Schema<HPBPBuyResponse>{
        ...
        @Override
        public HPBPBuyResponse newMessage() {
            return new HPBPBuyResponse();
        }

        @Override
        public Class<HPBPBuyResponse> typeClass() {
            return HPBPBuyResponse.class;
        }

        @Override
        public String messageName() {
            return HPBPBuyResponse.class.getSimpleName();
        }

        @Override
        public String messageFullName() {
            return HPBPBuyResponse.class.getName();
        }

        @Override
        @Deprecated
        public boolean isInitialized(HPBPBuyResponse message) {
            return true;
        }

        @Override
        public void mergeFrom(io.protostuff.Input input, HPBPBuyResponse instance) throws java.io.IOException {
        ...
        @Override
        public void writeTo(io.protostuff.Output output, HPBPBuyResponse instance) throws java.io.IOException {
    ...
    public static final class Builder  {
        ...
        public Builder mergeFrom(HPBPBuyResponse instance) {
        ...
        public Builder setReturnMessge(String value) {
            if (value == null) {
                throw new NullPointerException("Cannot set HPBPBuyResponse#returnMessge to null");
            }
        ...
        public Builder setTransactionId(String value) {
            if (value == null) {
                throw new NullPointerException("Cannot set HPBPBuyResponse#transactionId to null");
            }
        ...
        public Builder setOrderId(String value) {
            if (value == null) {
                throw new NullPointerException("Cannot set HPBPBuyResponse#orderId to null");
            }
        ...
        public Builder setItemId(String value) {
            if (value == null) {
                throw new NullPointerException("Cannot set HPBPBuyResponse#itemId to null");
            }
        ...
        public Builder setListClaimedBoosterItem(proto.message.HPBoosterPackInfoResponse value) {
            if (value == null) {
                throw new NullPointerException("Cannot set HPBPBuyResponse#listClaimedBoosterItem to null");
            }
        ...
        public Builder setListClaimedSpecialOfferItem(proto.message.HPSpecialOfferPackInfoResponse value) {
            if (value == null) {
                throw new NullPointerException("Cannot set HPBPBuyResponse#listClaimedSpecialOfferItem to null");
            }
        ...
        public HPBPBuyResponse build() {
            proto.message.HPBPBuyResponse result = new proto.message.HPBPBuyResponse();
