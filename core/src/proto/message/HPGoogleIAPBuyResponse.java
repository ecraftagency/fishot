...
public final class HPGoogleIAPBuyResponse
        implements io.protostuff.Message<HPGoogleIAPBuyResponse> {

    private static final HPGoogleIAPBuyResponse DEFAULT_INSTANCE = newBuilder().build();
    ...
    private HPGoogleIAPBuyResponse() {
        this.returnCode = 0;
        this.returnMessge = "";
        this.amount = 0;
        this.gold1 = 0;
    ...
    private HPGoogleIAPBuyResponse(Builder builder) {
        __merge_lock = true;
    }
    ...
    public static HPGoogleIAPBuyResponse getDefaultInstance() {
        return DEFAULT_INSTANCE;
    }

    public static io.protostuff.Schema<HPGoogleIAPBuyResponse> getSchema()
    {
    ...
    public HPGoogleIAPBuyResponse withReturnCode(int value) {
        return HPGoogleIAPBuyResponse.newBuilder()
            .mergeFrom(this)
            .setReturnCode(value)
            .build();
    }
    ...
    public HPGoogleIAPBuyResponse withReturnMessge(String value) {
        return HPGoogleIAPBuyResponse.newBuilder()
            .mergeFrom(this)
    ...
    public HPGoogleIAPBuyResponse withAmount(int value) {
        return HPGoogleIAPBuyResponse.newBuilder()
            .mergeFrom(this)
            .setAmount(value)
            .build();
    ...
    public HPGoogleIAPBuyResponse withGold1(int value) {
        return HPGoogleIAPBuyResponse.newBuilder()
            .mergeFrom(this)
            .setGold1(value)
            .build();
    ...
    public HPGoogleIAPBuyResponse withGold2(int value) {
        return HPGoogleIAPBuyResponse.newBuilder()
            .mergeFrom(this)
            .setGold2(value)
            .build();
    ...
    public HPGoogleIAPBuyResponse withGold3(int value) {
        return HPGoogleIAPBuyResponse.newBuilder()
            .mergeFrom(this)
            .setGold3(value)
            .build();
    ...
    public HPGoogleIAPBuyResponse withHappyPlayCount(int value) {
        return HPGoogleIAPBuyResponse.newBuilder()
            .mergeFrom(this)
    ...
    public HPGoogleIAPBuyResponse withTransactionId(String value) {
        return HPGoogleIAPBuyResponse.newBuilder()
            .mergeFrom(this)
    ...
    public HPGoogleIAPBuyResponse withHappyPlayEventNewCount(int value) {
        return HPGoogleIAPBuyResponse.newBuilder()
            .mergeFrom(this)
    ...
    public HPGoogleIAPBuyResponse withPetGoldBuff(int value) {
        return HPGoogleIAPBuyResponse.newBuilder()
            .mergeFrom(this)
    ...
    public HPGoogleIAPBuyResponse withTicketBuffCnt(int value) {
        return HPGoogleIAPBuyResponse.newBuilder()
            .mergeFrom(this)
    ...
    public HPGoogleIAPBuyResponse withItemId(String value) {
        return HPGoogleIAPBuyResponse.newBuilder()
            .mergeFrom(this)
            .setItemId(value)
            .build();
    ...
    public HPGoogleIAPBuyResponse withListClaimedBoosterItem(proto.message.HPBoosterPackInfoResponse value) {
        return HPGoogleIAPBuyResponse.newBuilder()
            .mergeFrom(this)
    ...
    public HPGoogleIAPBuyResponse withListClaimedSpecialOfferItem(proto.message.HPSpecialOfferPackInfoResponse value) {
        return HPGoogleIAPBuyResponse.newBuilder()
            .mergeFrom(this)
    ...
    @Override
    public io.protostuff.Schema<HPGoogleIAPBuyResponse> cachedSchema() {
        return Schema.INSTANCE;
    }
    ...
    public boolean equals(Object obj) {
        ...
        HPGoogleIAPBuyResponse that = (HPGoogleIAPBuyResponse) obj;
    ...
    public String toString() {
        ...
        return "HPGoogleIAPBuyResponse{" + String.join(", ", parts) + "}";
    }

    public static final class Schema implements io.protostuff.Schema<HPGoogleIAPBuyResponse>{
        ...
        static {
        	...
        	__fieldMap.put("itemId", 12);
        	__fieldMap.put("listClaimedBoosterItem", 13);
        	__fieldMap.put("listClaimedSpecialOfferItem", 14);
        }

        @Override
        public HPGoogleIAPBuyResponse newMessage() {
            return new HPGoogleIAPBuyResponse();
        }

        @Override
        public Class<HPGoogleIAPBuyResponse> typeClass() {
            return HPGoogleIAPBuyResponse.class;
        }

        @Override
        public String messageName() {
            return HPGoogleIAPBuyResponse.class.getSimpleName();
        }

        @Override
        public String messageFullName() {
            return HPGoogleIAPBuyResponse.class.getName();
        }

        @Override
        @Deprecated
        public boolean isInitialized(HPGoogleIAPBuyResponse message) {
            return true;
        }

        @Override
        public void mergeFrom(io.protostuff.Input input, HPGoogleIAPBuyResponse instance) throws java.io.IOException {
        ...
        @Override
        public void writeTo(io.protostuff.Output output, HPGoogleIAPBuyResponse instance) throws java.io.IOException {
            ...
            if((instance.__bitField0 & 2048) == 2048) {
                output.writeString(12, instance.itemId, false);
            }

            if((instance.__bitField0 & 4096) == 4096) {
            	output.writeObject(13, instance.listClaimedBoosterItem, proto.message.HPBoosterPackInfoResponse.getSchema(), false);
            }

            if((instance.__bitField0 & 8192) == 8192) {
            	output.writeObject(14, instance.listClaimedSpecialOfferItem, proto.message.HPSpecialOfferPackInfoResponse.getSchema(), false);
            }
        ...
        public String getFieldName(int number) {
        	switch(number) {
        		...
        		case 12: return "itemId";
        		case 13: return "listClaimedBoosterItem";
        		case 14: return "listClaimedSpecialOfferItem";
        		default: return null;
        	}
        }
    ...
    public static final class Builder  {
        ...
        public Builder mergeFrom(HPGoogleIAPBuyResponse instance) {
        ...
        public Builder setReturnMessge(String value) {
            if (value == null) {
                throw new NullPointerException("Cannot set HPGoogleIAPBuyResponse#returnMessge to null");
            }
        ...
        public Builder setTransactionId(String value) {
            if (value == null) {
                throw new NullPointerException("Cannot set HPGoogleIAPBuyResponse#transactionId to null");
            }
        ...
        public Builder setItemId(String value) {
            if (value == null) {
                throw new NullPointerException("Cannot set HPGoogleIAPBuyResponse#itemId to null");
            }
        ...
        public Builder setListClaimedBoosterItem(proto.message.HPBoosterPackInfoResponse value) {
            if (value == null) {
                throw new NullPointerException("Cannot set HPGoogleIAPBuyResponse#listClaimedBoosterItem to null");
            }
        ...
        public Builder setListClaimedSpecialOfferItem(proto.message.HPSpecialOfferPackInfoResponse value) {
            if (value == null) {
                throw new NullPointerException("Cannot set HPGoogleIAPBuyResponse#listClaimedSpecialOfferItem to null");
            }
        ...
        public HPGoogleIAPBuyResponse build() {
            proto.message.HPGoogleIAPBuyResponse result = new proto.message.HPGoogleIAPBuyResponse();
