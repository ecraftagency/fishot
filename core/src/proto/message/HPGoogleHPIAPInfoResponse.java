...
public final class HPGoogleHPIAPInfoResponse
        implements io.protostuff.Message<HPGoogleHPIAPInfoResponse> {

    private static final HPGoogleHPIAPInfoResponse DEFAULT_INSTANCE = newBuilder().build();
    ...
    private HPGoogleHPIAPInfoResponse() {
    ...
    private HPGoogleHPIAPInfoResponse(Builder builder) {
        __merge_lock = true;
    }
    ...
    public static HPGoogleHPIAPInfoResponse getDefaultInstance() {
        return DEFAULT_INSTANCE;
    }

    public static io.protostuff.Schema<HPGoogleHPIAPInfoResponse> getSchema()
    {
    ...
    public HPGoogleHPIAPInfoResponse withItems(java.util.List<proto.message.HPIAPInfo> value) {
        return HPGoogleHPIAPInfoResponse.newBuilder()
            .mergeFrom(this)
            .clearItems()
            .addAllItems(value)
            .build();
    ...
    public HPGoogleHPIAPInfoResponse withNewHappyPlayEventPercent(java.util.List<Float> value) {
        return HPGoogleHPIAPInfoResponse.newBuilder()
            .mergeFrom(this)
    ...
    public HPGoogleHPIAPInfoResponse withNewHappyPlayPetPercent(float value) {
        return HPGoogleHPIAPInfoResponse.newBuilder()
            .mergeFrom(this)
    ...
    public HPGoogleHPIAPInfoResponse withMinMoneyUnit(float value) {
        return HPGoogleHPIAPInfoResponse.newBuilder()
            .mergeFrom(this)
    ...
    public HPGoogleHPIAPInfoResponse withMinTicketUnit(float value) {
        return HPGoogleHPIAPInfoResponse.newBuilder()
            .mergeFrom(this)
    ...
    public HPGoogleHPIAPInfoResponse withPromotionPercent(float value) {
        return HPGoogleHPIAPInfoResponse.newBuilder()
            .mergeFrom(this)
    ...
    @Override
    public io.protostuff.Schema<HPGoogleHPIAPInfoResponse> cachedSchema() {
        return Schema.INSTANCE;
    }
    ...
    public boolean equals(Object obj) {
        ...
        HPGoogleHPIAPInfoResponse that = (HPGoogleHPIAPInfoResponse) obj;
    ...
    public String toString() {
        ...
        return "HPGoogleHPIAPInfoResponse{" + String.join(", ", parts) + "}";
    }

    public static final class Schema implements io.protostuff.Schema<HPGoogleHPIAPInfoResponse>{
        ...
        @Override
        public HPGoogleHPIAPInfoResponse newMessage() {
            return new HPGoogleHPIAPInfoResponse();
        }

        @Override
        public Class<HPGoogleHPIAPInfoResponse> typeClass() {
            return HPGoogleHPIAPInfoResponse.class;
        }

        @Override
        public String messageName() {
            return HPGoogleHPIAPInfoResponse.class.getSimpleName();
        }

        @Override
        public String messageFullName() {
            return HPGoogleHPIAPInfoResponse.class.getName();
        }

        @Override
        @Deprecated
        public boolean isInitialized(HPGoogleHPIAPInfoResponse message) {
            return true;
        }

        @Override
        public void mergeFrom(io.protostuff.Input input, HPGoogleHPIAPInfoResponse instance) throws java.io.IOException {
        ...
        @Override
        public void writeTo(io.protostuff.Output output, HPGoogleHPIAPInfoResponse instance) throws java.io.IOException {
    ...
    public static final class Builder  {
        ...
        public Builder mergeFrom(HPGoogleHPIAPInfoResponse instance) {
        ...
        public Builder setItems(int index, proto.message.HPIAPInfo value) {
            if (value == null) {
                throw new NullPointerException("Cannot set HPGoogleHPIAPInfoResponse#items to null");
            }
        ...
        public Builder addAllNewHappyPlayEventPercent(java.lang.Iterable<Float> values) {
            if (values == null) {
                throw new NullPointerException("Cannot set HPGoogleHPIAPInfoResponse#newHappyPlayEventPercent to null");
            }
            if(!((__bitField0 & 2) == 2)) {
                this.newHappyPlayEventPercent = new java.util.ArrayList<>();
                __bitField0 |= 2;
        ...
        public HPGoogleHPIAPInfoResponse build() {
            proto.message.HPGoogleHPIAPInfoResponse result = new proto.message.HPGoogleHPIAPInfoResponse();
