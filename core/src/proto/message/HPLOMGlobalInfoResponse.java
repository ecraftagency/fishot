...
public final class HPLOMGlobalInfoResponse
        implements io.protostuff.Message<HPLOMGlobalInfoResponse> {

    private static final HPLOMGlobalInfoResponse DEFAULT_INSTANCE = newBuilder().build();
    ...
    private HPLOMGlobalInfoResponse() {
    ...
    private HPLOMGlobalInfoResponse(Builder builder) {
        __merge_lock = true;
    }
    ...
    public static HPLOMGlobalInfoResponse getDefaultInstance() {
        return DEFAULT_INSTANCE;
    }

    public static io.protostuff.Schema<HPLOMGlobalInfoResponse> getSchema()
    {
    ...
    public HPLOMGlobalInfoResponse withItems(java.util.List<proto.message.HPIAPInfo> value) {
        return HPLOMGlobalInfoResponse.newBuilder()
            .mergeFrom(this)
            .clearItems()
            .addAllItems(value)
            .build();
    ...
    public HPLOMGlobalInfoResponse withNewHappyPlayEventPercent(java.util.List<Float> value) {
        return HPLOMGlobalInfoResponse.newBuilder()
            .mergeFrom(this)
    ...
    public HPLOMGlobalInfoResponse withNewHappyPlayPetPercent(float value) {
        return HPLOMGlobalInfoResponse.newBuilder()
            .mergeFrom(this)
    ...
    public HPLOMGlobalInfoResponse withMinMoneyUnit(float value) {
        return HPLOMGlobalInfoResponse.newBuilder()
            .mergeFrom(this)
    ...
    public HPLOMGlobalInfoResponse withMinTicketUnit(float value) {
        return HPLOMGlobalInfoResponse.newBuilder()
            .mergeFrom(this)
    ...
    public HPLOMGlobalInfoResponse withListChannel(java.util.List<String> value) {
        return HPLOMGlobalInfoResponse.newBuilder()
            .mergeFrom(this)
            .clearListChannel()
    ...
    public HPLOMGlobalInfoResponse withPromotionPercent(float value) {
        return HPLOMGlobalInfoResponse.newBuilder()
            .mergeFrom(this)
    ...
    @Override
    public io.protostuff.Schema<HPLOMGlobalInfoResponse> cachedSchema() {
        return Schema.INSTANCE;
    }
    ...
    public boolean equals(Object obj) {
        ...
        HPLOMGlobalInfoResponse that = (HPLOMGlobalInfoResponse) obj;
    ...
    public String toString() {
        ...
        return "HPLOMGlobalInfoResponse{" + String.join(", ", parts) + "}";
    }

    public static final class Schema implements io.protostuff.Schema<HPLOMGlobalInfoResponse>{
        ...
        @Override
        public HPLOMGlobalInfoResponse newMessage() {
            return new HPLOMGlobalInfoResponse();
        }

        @Override
        public Class<HPLOMGlobalInfoResponse> typeClass() {
            return HPLOMGlobalInfoResponse.class;
        }

        @Override
        public String messageName() {
            return HPLOMGlobalInfoResponse.class.getSimpleName();
        }

        @Override
        public String messageFullName() {
            return HPLOMGlobalInfoResponse.class.getName();
        }

        @Override
        @Deprecated
        public boolean isInitialized(HPLOMGlobalInfoResponse message) {
            return true;
        }

        @Override
        public void mergeFrom(io.protostuff.Input input, HPLOMGlobalInfoResponse instance) throws java.io.IOException {
        ...
        @Override
        public void writeTo(io.protostuff.Output output, HPLOMGlobalInfoResponse instance) throws java.io.IOException {
    ...
    public static final class Builder  {
        ...
        public Builder mergeFrom(HPLOMGlobalInfoResponse instance) {
        ...
        public Builder setItems(int index, proto.message.HPIAPInfo value) {
            if (value == null) {
                throw new NullPointerException("Cannot set HPLOMGlobalInfoResponse#items to null");
            }
        ...
        public Builder addAllNewHappyPlayEventPercent(java.lang.Iterable<Float> values) {
            if (values == null) {
                throw new NullPointerException("Cannot set HPLOMGlobalInfoResponse#newHappyPlayEventPercent to null");
            }
            if(!((__bitField0 & 2) == 2)) {
                this.newHappyPlayEventPercent = new java.util.ArrayList<>();
                __bitField0 |= 2;
        ...
        public Builder setListChannel(int index, String value) {
            if (value == null) {
                throw new NullPointerException("Cannot set HPLOMGlobalInfoResponse#listChannel to null");
            }
        ...
        public HPLOMGlobalInfoResponse build() {
            proto.message.HPLOMGlobalInfoResponse result = new proto.message.HPLOMGlobalInfoResponse();
