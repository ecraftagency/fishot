...
import com.fruit.controllers.SliceMode;
...
import com.fruit.views.SliceUILayer;
import com.fruit.views.SwipeRenderer;

public class SliceGameScreen implements Screen {
  ...
  private               SliceUILayer              uiRenderer;
  ...
  public SliceGameScreen() {
    ...
    uiRenderer                = new SliceUILayer();
    modeLogic                 = new SliceMode(ThrowEngine.inst());
